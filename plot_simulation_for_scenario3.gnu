...
set output 'propagation_plot_for_scenario3.png'
...
plot 'scenario3_simulation_results.txt' using 1:2 with lines title 'Susceptible Nodes Count', \
     'scenario3_simulation_results.txt' using 1:3 with lines title 'Infected Nodes Count'
